...
<div class="modal fade" id="OrderModal" tabindex="-1" role="dialog" aria-labelledby="productModal"
     aria-hidden="true">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-10">
                            <div class="row">
                                ...
                                <div class="col-12 my-3" id="promo_check">
                                    <div class="row">
                                        <div class="col-6">
                                            <label for="event_name">Введите промокод</label>
                                            <div class="md-form mt-0">
                                                <input placeholder="Промокод*" type="text" name="promo" id="promo"
                                                       class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-6 d-flex align-items-center">
                                            <button class="btn btn-warning check-promo">
                                                Проверить промокод
                                            </button>
                                            <div class="py-1 promo-success text-success">
                                                <i class="far fa-check-circle text-success"></i> Промокод принят. Скидка <span class="promo-discount"></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12 my-0">
                                    <p class="mb-0">Мероприятие: <span class="ml-2 font-weight-bold">{{$event->title}}</span></p>
                                </div>
                                <div class="col-12 my-0">
                                    <p class="mb-0">Дата проведения мероприятия: <span class="ml-2 font-weight-bold">{{$event->date}}</span></p>
                                </div>
                                @if($event->scheme == 1)
                                <div class="col-6 my-0">
                            ...
                            <form class="row justify-content-center pt-5" action="">
                                ...
                                <div class="btn btn-warning buy-ticket agree_check agree_block" style="transition: 0.5s" data-id="{{$event->id}}" data-parent=""  data-parent2="{{$event->rate[0][2]}}">Отправить</div>
                                </div>
                            </form>
                        </div>
                    </div>
