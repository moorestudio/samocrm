<div class="modal fade" id="UnregBuy" tabindex="-1" role="dialog" aria-labelledby="productModal"
     aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-4">
                ...
                <p class="text-left" style="color:#EF6E6E;font-size: 14;">
                    Покупка билетов доступна зарегистрированным пользователям, если хотите приобрести билет заполните анкету, и подтвердите свою почту.
                </p>
            ...
            <div class="pb-4 card register-form" style="margin-top:3%;">
                <div class="d-flex flex-wrap justify-content-between">
                    <div class="reg_title col-lg-4 col-12 px-2 pt-0">Регистрация</div>
                    <a class="reg_title reg_title_auth col-lg-4 col-12 px-2 pt-0" href="/login">Авторизация</a>
                    <div class="title-reg2 col-lg-4 col-12 d-flex align-items-center justify-content-center"><span class="reg_step reg_step-dop pt-0">Шаг 01 из 02</span></div>
                </div>
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="max-width: 700px;">
    <div class="modal-content  pl-5 pr-5 pb-4 pt-4">
          ...
          <div class="modal-header pl-0 pr-0 pt-0 pb-4"  style="border: none;">
            <h5 class="modal-title">Условия соглашения</h5>
            <button type="button" id="inner_modal_close" class="close" data-dismiss="user_agreement_modal" aria-label="Close">
...
(function($){
    ...
    $('#inner_modal_close').on('click', function (e) {
        $('#user_agreement_modal').modal('hide');
    })
