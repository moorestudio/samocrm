...
<div class="email_body_class">
    ...
    <p class="email_body_thanx">Вы запросили смену пароля.</p>
    <div class="email_body_button">
    <a href="{{$actionUrl}}" style="color: white;">Сменить пароль!</a>
    </div>
    <br>
    <p class="email_body_bold">Эта ссылка для смены пароля будет действителльна 1 час</p> 
</div>
</div>
</body>
</html>
