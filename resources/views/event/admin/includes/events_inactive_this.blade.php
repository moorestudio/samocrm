                ...
                <div class="p-4 event-info w-100">
                    ...
                    @if(Auth::user()->role_id == 5 || Auth::user()->role_id == 4 || Auth::user()->role_id == 6)
                        @if(isset($event->link_new))
                            <div class="text-left">
                                <p class="reff_link" style="font-size:13px; line-height:13px; color:rgba(30,36,51,0.6);    margin: 0;
    padding-top: 6%;    padding-bottom: 5%;"><i
                                            style="color:#F38230;"
                        ...
                        @else
                            <div class="text-left my-3">
                                <button class="text-white reff_link_btn"
                                      style="font-size:13px; cursor:pointer;color:rgba(30,36,51,0.6);"
                                      event_id="{{$event->id}}">Создать реферальную ссылку
                                </button>
                                <div class="d-flex align-items-center justify-content-center position-relative dropmenu-action tochk" style="">
