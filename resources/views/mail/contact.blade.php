...
<div class="email_body_class">
	...
	<p class="email_body_thanx">Заявка от, {{ $name }}</p>
	<p class="email_body_thanx">Телефон: <strong>{{ $phone }}</strong></p>
	<p class="email_body_thanx">Тип обращения: <strong>{{ $type }}</strong></p>
	<p class="email_body_thanx">E-mail: <strong>{{ $email }}</strong></p>
	<p class="email_body_thanx">Комментарий: {{ $comment }}</p>
</div>
</div>
</body>
</html>