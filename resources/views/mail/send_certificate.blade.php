...
<div class="email_body_class">
	<p class="email_body_bold">Здравствуйте! {{$user}}</p>
	<p class="email_body_thanx">Ваш сертификат за мероприятие {{$event}}</p>
  <div class="email_pdf_btn_content" style="justify-content:center;">
    <a class="email_download_pdf_btn" href="{{url('certificate_show/'.$ticket)}}">Сертификат</a>
  </div>
</div>
</div>
</body>
