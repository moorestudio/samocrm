...
<div class="email_body_class">
	...
	<p class="email_body_thanx">Вы изменили свой Email, ниже Ваш новый логин и ссылка для подтверждения.</p>
	<p class="email_body_bold">Ваш новый логин:</p>
	<span>E-mail:</span><br>
	<span style="color: #3F8CFF; font-weight: bold;">{{$email}}</span><br>
	<span class="email_body_bold" style="display: block;margin-top: 5%;">Для подтверждения новой Email нажмите на кнопку ниже:</span><br>
